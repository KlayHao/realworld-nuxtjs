  ...
  methods: {
    async onSubmit() {
      try {
        ...
        this.$store.commit("setUser", data.user); // 为了反正刷新页面，需要数据持久化
